...
%% 每次必须修改所有参数
dataFile='D:\Minjl\4.29\赵佳琦\右肩动adc_data.mat';%原文件D:\Minjl\4.5头扫描\头端雷达\大幅头动3次adc_data.mat
selRange=12;%不同部位，不同range，11，12, 16，23

%% 主体
indexFile='D:\运动识别课题\阶段三：目标姿势分析\matlab\Version2\index.txt';%这个固定不变
load(dataFile);
